...
namespace Hooks
{
    ...
    enum PlayerEvents
    {
        ...
        PLAYER_SEND_MYTHIC_UPDATE_DEATH = 55,
        PLAYER_SEND_MYTHIC_UPDATE_START = 56,
        PLAYER_SEND_MYTHIC_UPDATE_TIMER = 57,
        PLAYER_SEND_MYTHIC_UPDATE_CHEST = 58,
        PLAYER_SEND_MYTHIC_UPDATE_BOSS = 59,
        PLAYER_SEND_MYTHIC_UPDATE_MINION = 60,
        PLAYER_SEND_MYTHIC_SHOW_UI = 61,
        PLAYER_SEND_MYTHIC_UPDATE_BEGIN = 62,
        PLAYER_SEND_MYTHIC_UPDATE_COMPLETED = 63,
        PLAYER_SEND_MYTHIC_UPDATE_PREPERATION = 64,

...
void Eluna::OnActivateSpec(Player* pPlayer, std::string message, bool activated, uint32 specId)
{
...
void Eluna::SendCompletedMythicDungeon(Player* pPlayer, uint32 timer, uint8 upgrade)
{
...
void Eluna::SendPreperationMythicDungeon(Player* pPlayer, std::string name, uint32 timer, uint32 level, float damage, float health)
{
